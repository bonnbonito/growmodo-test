...
<div class="entry-meta">
	...
	if ( '' !== $time_string && '0' !== $time_string ) {
		...
		<span class="posted-on">
			...
			printf(
				...
				esc_html_x( 'Posted on %s', 'post date', 'bonn-growmodo' ),
	...
	if ( '' !== $author_string && '0' !== $author_string ) {
		?>
		<span class="posted-by">
			<?php
			/* translators: %s: post author */
			$author_byline = _x( 'By %s', 'post author', 'bonn-growmodo' );
			if ( '' !== $time_string && '0' !== $time_string ) {
				/* translators: %s: post author */
				$author_byline = _x( 'by %s', 'post author', 'bonn-growmodo' );
			}
	...
	if ( '' !== $parent_string && '0' !== $parent_string ) {
		?>
		<span class="posted-in">
			<?php
			/* translators: %s: post parent title */
			$parent_note = _x( 'In %s', 'post parent', 'bonn-growmodo' );
