<?php
/**
 * Bonn\GrowModo\Sidebars\Component class
 *
...
namespace Bonn\GrowModo\Sidebars;
 ...
 * * `bonn_growmodo()->is_primary_sidebar_active()`
 * * `bonn_growmodo()->display_primary_sidebar()`
 *
...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function action_register_sidebars() {
		register_sidebar(
			array(
				'name' => esc_html__( 'Sidebar', 'bonn-growmodo' ),
				'id' => static::PRIMARY_SIDEBAR_SLUG,
				'description' => esc_html__( 'Add widgets here.', 'bonn-growmodo' ),
