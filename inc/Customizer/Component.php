<?php
/**
 * Bonn\GrowModo\Customizer\Component class
 *
 * @package bonn_growmodo
 */

namespace Bonn\GrowModo\Customizer;
...
class Component implements Component_Interface {
	...
	public function action_customize_register( WP_Customize_Manager $wp_customize ) {
		...
		$wp_customize->add_section(
			'theme_options',
			array(
				'title'    => __( 'Theme Options', 'bonn-growmodo' ),
	...
	public function action_enqueue_customize_preview_js() {
		wp_enqueue_script(
			'bonn-growmodo-customizer',
			get_theme_file_uri( '/assets/js/customizer.min.js' ),
			array( 'customize-preview' ),
			bonn_growmodo()->get_asset_version( get_theme_file_path( '/assets/js/customizer.min.js' ) ),
			true
		);
	}
}
