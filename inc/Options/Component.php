...
namespace Bonn\GrowModo\Options;
...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function template_tags(): array {
		return array(
			'get_setting' => array( $this, 'get_setting' ),
		);
	}
	...
	public function get_setting( string $setting_key, $default_value = '' ) {
		$settings = get_option( 'bonn_growmodo_theme_settings', array() );
	...
	public function theme_options_enqueue_scripts(): void {
		...
		$settings = get_option( 'bonn_growmodo_theme_settings', '' );

		wp_localize_script(
			'bonn-growmodo-theme-settings',
			'bonnGrowmodoThemeSettings',
			array(
	...
	/**
	 * Adds an admin menu page for Bonn GrowModo settings.
	 */
	public function add_admin_menu(): void {
		add_menu_page(
			__( 'Bonn GrowModo Settings', 'bonn-growmodo' ),
			__( 'Bonn GrowModo Settings', 'bonn-growmodo' ),
			'manage_options',
			'bonn-growmodo-settings',
	...
	public function update_settings( WP_REST_Request $request ): WP_REST_Response|WP_Error {
		...
		update_option( 'bonn_growmodo_theme_settings', $settings );
