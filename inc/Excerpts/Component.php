<?php
/**
 * Bonn\GrowModo\Excerpts\Component class
 *
 * @package bonn_growmodo
 */

namespace Bonn\GrowModo\Excerpts;
...
class Component implements Component_Interface {
	...
	public function new_excerpt_more() {
		$link = sprintf(
			...
			sprintf( __( 'Continue reading<span class="screen-reader-text"> "%s"</span>', 'bonn-growmodo' ), get_the_title( get_the_ID() ) )
		);
		return ' &hellip; ' . $link;
	}
}
